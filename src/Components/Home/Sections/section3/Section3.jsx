...
export default function Section3() {
  return (
    <>
        <Container id="nutrition" className="section-padding">
          <Row>
          ...
          <div className="my-5">
            <Row>
                ...
                <div className='col-md-6 d-flex align-items-center'>
                  <p className='text-paragraph-color header2-size'>Track your activities and what you eat with the help of our food-, exercise- and water trackers to maintain a balanced everyday life.</p>
                </div>
            </Row>
